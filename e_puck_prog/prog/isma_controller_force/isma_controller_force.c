...
#define RULE2_WEIGHT      0.015        // Weight of dispersion rule. default 0.02/10
#define RULE3_WEIGHT      0.003        // Weight of consistency rule. default 1.0/10
#define MARGINAL_THRESHOLD 0.22
#define MIGRATION_WEIGHT  0.003        // Wheight of attraction towards the common goal. default 0.01/10
...
void reset(void)
{
  ...
  e_activate_agenda(telemetry,50000);
...
void update_self_motion(int msl, int msr)
{
  ...
  dist_left = e_get_steps_left()*2.0*PI*WHEEL_RADIUS/1000.0;   // In meters
  e_set_steps_left(0);
  dist_right = e_get_steps_right()*2.0*PI*WHEEL_RADIUS/1000.0; // In meters
  e_set_steps_right(0);
