...
static void reset(){
	...
	myself.my_position[1] = 0;			// Set initial Y position of myself to 0
...
int main(){
	...
	for(;;){
		...
		msl = msl * MAX_SPEED / 1000;
		msr = msr * MAX_SPEED / 1000;
